...
class QuestionController {
  get_single_question(req, res, next) {
    execute_query(QuestionController.getQueryByQuestionType(req.query.question_type))
      .then((result) => {
        res.data = result[0] || {};
  ...
  static getQueryByQuestionType(question_type) {
